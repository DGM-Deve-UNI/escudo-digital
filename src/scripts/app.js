...
//     // CORREÇÃO: Usar apenas uma estrutura de opções
...
//     // CORREÇÃO: Atualizar o seletor para .option-item
...
//     // Marcar todas as respostas com as classes apropriadas
...
//       if (index === selected) {
//         item.classList.add("selected"); // Resposta selecionada (destaque)
//       }
//     });
...
//               scores.fase1
//             } / ${totalFase1} acertos</p>
//             <p><strong>Fase 2:</strong> ${
//               scores.fase2
//             } / ${totalFase2} acertos</p>
//             <p><strong>Total:</strong> ${scores.fase1 + scores.fase2} / ${
//       totalFase1 + totalFase2
//     } acertos</p>
